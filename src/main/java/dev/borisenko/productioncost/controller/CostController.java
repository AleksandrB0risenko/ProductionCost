...
public interface CostController {
    ...
    ResponseEntity<?> getAll(@PathVariable("id") int id);
    ...
    @PostMapping("/add")
        //@PreAuthorize("hasRole('USER')")
    ResponseEntity<?> add(@Valid @RequestBody Cost cost);
    ...
    @PutMapping("/update/{id}")
        //@PreAuthorize("hasRole('USER')")
    ResponseEntity<?> update(@PathVariable("id") int id, @Valid @RequestBody Cost cost);
}
